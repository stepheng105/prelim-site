// ============================================================
// home.js
// Drives pages that use either or both of:
//   #progress-container   (aggregate finished/unfinished bars)
//   #generator-container  (cross-subject random question generator)
// Each section only runs if its container exists on the page,
// so this one file safely serves index.html, the dev page, or
// any future page that only needs one of the two.
// ============================================================
